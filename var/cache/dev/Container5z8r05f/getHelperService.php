...
// Returns the public 'AppBundle\Service\Helper' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Service/Helper.php';

return $this->services['AppBundle\Service\Helper'] = new \AppBundle\Service\Helper();
