...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminproject'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminprofile'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admincategories'), array(0 => 'ROLE_ADMIN'), NULL);
