...
class __TwigTemplate_fa7b2fee16f8d1790b375bd0ea35645d710317469894b5c649eaaf876df3a648 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("baseadmin.html.twig", "project/index.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"list-group\">
        ";
        // line 10
        if (($context["projects"] ?? $this->getContext($context, "projects"))) {
            // line 11
            echo "            ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
                // line 12
                echo "                <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("project_edit", array("id" => $this->getAttribute($context["p"], "id", array()))), "html", null, true);
...
";
    ...
    {
        return array (  85 => 17,  82 => 16,  73 => 13,  68 => 12,  63 => 11,  61 => 10,  53 => 5,  49 => 3,  40 => 2,  11 => 1,);
    }
...
{% block body %}
    ...
    <h2 class=\"headline\">Projects
        <a href=\"{{ path('project_new') }}\" style=\"float: right;\">
            <button type=\"button\" class=\"btn btn-dark\">Add project +</button>
        </a>
    </h2>
    <div class=\"list-group\">
        {% if projects %}
            {% for p in projects %}
                <a href=\"{{ path('project_edit', {'id': p.id}) }}\" class=\"list-group-item list-group-item-action\">
                    {{ p.name }}
                </a>
            {% endfor %}
        {% endif %}
    </div>
{% endblock %}", "project/index.html.twig", "C:\\wamp64\\www\\omh\\app\\Resources\\views\\project\\index.html.twig");
    }
}
