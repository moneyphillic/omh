...
class __TwigTemplate_a9f6bbd1b02495b04623ef52236c32ced3369dc77cb1575fe9809ec39d6f7246 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "\" method=\"post\" style=\"width: 500px; margin: 0 auto; margin-top: 200px;\">
        ";
        // line 4
        ...
        echo "        <div class=\"form-group\">
            ...
            <input name=\"_username\" type=\"text\" class=\"form-control\" placeholder=\"Enter username\" value=\"";
        // line 9
...
";
    ...
    {
        return array (  66 => 9,  62 => 7,  56 => 5,  54 => 4,  49 => 3,  40 => 2,  11 => 1,);
    }
...
{% block body %}
    <form action=\"{{ path('login') }}\" method=\"post\" style=\"width: 500px; margin: 0 auto; margin-top: 200px;\">
        {% if error %}
            <div>{{ error.messageKey|trans(error.messageData, 'security') }}</div>
        {% endif %}
        <div class=\"form-group\">
            <label for=\"exampleInputEmail1\">Username</label>
            <input name=\"_username\" type=\"text\" class=\"form-control\" placeholder=\"Enter username\" value=\"{{ last_username }}\">
        </div>
        <div class=\"form-group\">
            <label for=\"exampleInputPassword1\">Password</label>
            <input name=\"_password\" type=\"password\" class=\"form-control\" placeholder=\"Password\">
...
{% endblock %}", "security/login.html.twig", "C:\\wamp64\\www\\omh\\app\\Resources\\views\\security\\login.html.twig");
    }
}
