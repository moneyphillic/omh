...
class __TwigTemplate_c4f0fec3a4460c45bc7aa1baec633c5fd77f91423d063b5a630b5898232768a2 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "\" onclick=\"window.location = '/contact-me'\" style=\"text-decoration: none; text-align: center;\">Contact me</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <section class=\"mb-xl\" style=\"margin-top: 40px;\">
            <div class=\"container\">
                <ul class=\"accordion\">
                    <li class=\"active\">
                        <div class=\"head\" style=\"text-align: center;\">
                            <a href=\"{{ path('contactme') }}\" onclick=\"window.location = '/contact-me'\" style=\"text-decoration: none; text-align: center;\">Contact me</a>
                        </div>
                    </li>
                </ul>
            </div>
...
{% endblock %}", "template/projectsingle.html.twig", "/Users/kamenovivan/Documents/Projects/Web/omh/app/Resources/views/template/projectsingle.html.twig");
    }
}
