...
/* baseadmin.html.twig */
class __TwigTemplate_e3a1d2f082c27bc6f6daa552df82b6fd9aa2cbf29dd5d802c3f93df4ff7d632f extends Twig_Template
{
...
<main style=\"max-width: 1040px; margin: 0 auto;\">
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light admin-navbar\" ";
        // line 17
        if (($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "get", array(0 => "_route"), "method") == "login")) {
            echo "style=\"display: none\"";
        }
        echo ">
        <div class=\"collapse navbar-collapse\" id=\"navbarNavAltMarkup\">
            <div class=\"navbar-nav\">
                <a class=\"nav-item nav-link admin-nav-item\" href=\"";
        // line 20
        ...
        echo "\" style=\"float: right\">Logout</a>
                </li>
            </ul>
        </div>
    </nav>
    <div class=\"wrapper\" style=\"padding: 0px 15px\">
        ";
        // line 34
...
";
    ...
    {
        return array (  167 => 37,  150 => 34,  133 => 7,  115 => 6,  103 => 38,  101 => 37,  97 => 35,  95 => 34,  86 => 28,  77 => 22,  73 => 21,  69 => 20,  61 => 17,  54 => 13,  48 => 10,  42 => 8,  40 => 7,  36 => 6,  29 => 1,);
    }
...
<body>
<main style=\"max-width: 1040px; margin: 0 auto;\">
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light admin-navbar\" {% if app.request.get('_route') == 'login' %}style=\"display: none\"{% endif %}>
        <div class=\"collapse navbar-collapse\" id=\"navbarNavAltMarkup\">
            <div class=\"navbar-nav\">
                <a class=\"nav-item nav-link admin-nav-item\" href=\"{{ path('project_index') }}\">Projects</a>
                <a class=\"nav-item nav-link admin-nav-item\" href=\"{{ path('categories_index') }}\">Categories</a>
                <a class=\"nav-item nav-link admin-nav-item\" href=\"{{ path('profile_index') }}\">Profile</a>
            </div>
        </div>
        <div class=\"navbar-collapse collapse w-100 order-3 dual-collapse2\">
            <ul class=\"navbar-nav ml-auto\">
                <li class=\"nav-item\">
                    <a class=\"nav-item nav-link admin-nav-item\" href=\"{{ path('logout') }}\" style=\"float: right\">Logout</a>
                </li>
            </ul>
        </div>
    </nav>
...
", "baseadmin.html.twig", "C:\\wamp64\\www\\omh\\app\\Resources\\views\\baseadmin.html.twig");
    }
}
